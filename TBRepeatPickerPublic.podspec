...
Pod::Spec.new do |s|
  s.name                 = "TBRepeatPickerPublic"
  s.version              = "1.1.1"
  s.summary              = "An event repeat rule picker similar to iOS system calendar."
  s.homepage             = "https://github.com/tman94/TBRepeatPicker.git"
  s.license              = { :type => 'MIT', :file => 'LICENSE.txt' }
  s.author               = { "Xin Hong" => "xin@teambition.com" }
  s.source               = { :git => "https://github.com/tman94/TBRepeatPicker.git", :tag => s.version.to_s }
  s.platform             = :ios, '8.0'
  s.requires_arc         = true
